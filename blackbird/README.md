...
- blackbird-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- blackbird-ui: main application module, development time
- blackbird-production-war: module that produces a production mode WAR for deployment
